...
from femsolver_FrontISTR.solver import ANALYSIS_TYPES


def check_member_for_solver_fistr(analysis, solver, mesh, member):
    ...
    if solver.AnalysisType == "frequency":  ### Not supported ###
    ...
    for m in member.mats_linear:
        ...
        if femutils.is_of_type(mat_obj, "Fem::MaterialReinforced"):  ### Not supported ###
    ...
    for m in member.mats_linear:
        ...
        for nlm in (member.mats_nonlinear + member.mats_visco_fistr + member.mats_creep_fistr):
