...
__title__ = "Result import for FrontISTR dat file format"
__author__ = "FrontISTR Commons"
__url__ = "https://www.frontistr.com/"

## @package importfistrDatResults
#  \ingroup FEM
#  \brief FreeCAD FrontISTR DAT reader for FEM workbench
...
# read a FrontISTR result file and extract the data
def readResult(
    dat_input
):
    Console.PrintMessage("Read fistr results from dat file: {}\n".format(dat_input))
